...
class Mov(object):
    ...
    def format_string(self, key, value):
      key = key.replace(' ', '_')
      key = key.lower()
    ...
    def _parse_atom(self, atom, length, depth, variable=False, chained=False):
        ...
        for i in range(len(k)):
            ...
            # print("{} | {}{}: {}".format(atom, prefix, k[i], vv))
            # print("{}_{}: {}".format(atom, k[i], vv))
            self.format_string("{} {}".format(atom, k[i]), vv)
        ...
        if variable or chained:
            ...
            if len(realdata) > lim:
                ...
                # print("{}_{}: {}".format(atom, spec[4], realdata))
                self.format_string("{} {}".format(atom, spec[4]), vv)
